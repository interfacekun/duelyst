...
class ChromaInstance extends Devices_1.default {
    ...
    heartbeat() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield request_1.default(this.url + "/heartbeat", {
                method: "put",
            });
            if (!response.ok) {
                throw Error(response.statusText);
    ...
    sendDeviceUpdate(devices, store = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const device of devices) {
                ...
                const deviceresponse = yield request_1.default(this.url + "/" + name, {
    ...
    setEffect(effectids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const effectid of effectids) {
                ...
                const deviceresponse = yield request_1.default(this.url + "/effect", {
                    body: payload,
